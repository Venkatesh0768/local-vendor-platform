package org.localvendor.backend.auth.service.impl;

import jakarta.transaction.Transactional;
import lombok.RequiredArgsConstructor;
import org.localvendor.backend.auth.dto.ApiResponse;
import org.localvendor.backend.auth.dto.ResetPasswordRequest;
import org.localvendor.backend.auth.dto.UserDto;
import org.localvendor.backend.auth.model.User;
import org.localvendor.backend.auth.repositories.UserRepository;
import org.localvendor.backend.auth.service.UserService;
import org.localvendor.backend.exception.InvalidOtpException;
